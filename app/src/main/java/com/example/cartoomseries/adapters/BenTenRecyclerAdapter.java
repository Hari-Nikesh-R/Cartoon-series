...
public class BenTenRecyclerAdapter extends RecyclerView.Adapter<BenTenRecyclerAdapter.UserViewHolder> {
    ...
    public UserViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
       ...
       // View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_userdata,parent,false);
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_benten,parent,false);
    ...
    public static class UserViewHolder extends RecyclerView.ViewHolder{
        ...
        public UserViewHolder(View view)
        {
            super(view);
            root = view;
            logo = view.findViewById(R.id.ben_10_poster);
            title = view.findViewById(R.id.ben_10_title);
            type = view.findViewById(R.id.ben_type);
            date = view.findViewById((R.id.ben_10_year));
            imDb = view.findViewById(R.id.ben_10_rating);
