...
public class UserLinearRecyclerAdapter extends RecyclerView.Adapter<UserLinearRecyclerAdapter.UserViewHolder> {
    private final List<SearchItem> searchItemsList;
   IUserAdapterCommunicator iUserAdapterCommunicator;

    public UserLinearRecyclerAdapter(List<SearchItem> searchItems,IUserAdapterCommunicator iUserAdapterCommunicator)
    {
    ...
    public UserViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
       ...
       // View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_userdata,parent,false);
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_naruto,parent,false);
